...
const struct of_device_id fromimx390_to_ar0330_of_match[] = {
	{ .compatible = "nvidia,fromimx390_to_ar0330",},
	{ },
};
MODULE_DEVICE_TABLE(of, fromimx390_to_ar0330_of_match);
...
static int imx390_gmsl_serdes_setup(struct imx390 *priv)
{
	...
	err = max9271_read_i2c(priv->i2c_client, 0);
	err = max9271_read_i2c(priv->i2c_client, 0x1E);
...
static struct camera_common_pdata *imx390_parse_dt(struct tegracam_device *tc_dev)
{
	...
	match = of_match_device(fromimx390_to_ar0330_of_match, dev);
	if (!match) {
...
static struct camera_common_pdata *fromimx390_to_ar0330_parse_dt(struct i2c_client *client)
{
	...
	match = of_match_device(fromimx390_to_ar0330_of_match, &client->dev);
	if (!match) {
	...
	{
		printk("OK to find matching dt id\n");
	}
...
static int fromimx390_to_ar0330_remove(struct i2c_client *client)
{
...
static const struct i2c_device_id fromimx390_to_ar0330_id[] = {
	{ "fromimx390_to_ar0330", 0 },
	{ }
};

MODULE_DEVICE_TABLE(i2c, fromimx390_to_ar0330_id);

static struct i2c_driver fromimx390_to_ar0330_i2c_driver = {
	.driver = {
		.name = "fromimx390_to_ar0330",
		.owner = THIS_MODULE,
		.of_match_table = of_match_ptr(fromimx390_to_ar0330_of_match),
	},
	.probe = fromimx390_to_ar0330_probe,
	.remove = fromimx390_to_ar0330_remove,
	.id_table = fromimx390_to_ar0330_id,
};
...
static int __init imx390_init(void)
{
	...
	return i2c_add_driver(&fromimx390_to_ar0330_i2c_driver);
}
...
static void __exit imx390_exit(void)
{
	...
	i2c_del_driver(&fromimx390_to_ar0330_i2c_driver);
}
