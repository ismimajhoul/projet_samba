...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_read \n");
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_write \n");
...
void max9271_wake_up(struct max9271_device *dev)
{
	...
	dev_err(&dev->client->dev,"MAX9271 max9271_wake_up \n");
	/*
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_configure_i2c \n");
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_set_high_threshold \n");
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_configure_gmsl_link \n");
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_set_gpios \n");
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_clear_gpios \n");
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_enable_gpios \n");
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_disable_gpios \n");
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_verify_id \n");
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_set_address \n");
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_set_deserializer_address \n");
...
{
	int ret;
	dev_err(&dev->client->dev,"MAX9271 max9271_set_translation \n");
