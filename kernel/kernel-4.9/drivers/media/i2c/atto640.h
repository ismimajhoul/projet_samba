/*
 * atto640.h - atto640 sensor mode tables
 *
...
#ifndef __ATTO640_TABLES__
#define __ATTO640_TABLES__

#include <media/camera_common.h>

#define atto640_reg struct reg_16
#define ATTO640_TABLE_WAIT_MS	0
#define ATTO640_TABLE_END	1
#define ATTO640_WAIT_MS		10
#define ATTO640_DEFAULT_MODE	0

#define ATTO640_DEFAULT_WIDTH    640
#define ATTO640_DEFAULT_HEIGHT	480
#define ATTO640_DEFAULT_DATAFMT	MEDIA_BUS_FMT_UYVY8_1X16
#define ATTO640_NUM_CONTROLS 30
...
static void atto640_toggle_gpio(unsigned int gpio, int value);

//static int atto640_mcu_get_fw_version(struct i2c_client *client, unsigned char * fw_version, unsigned char *txt_fw_version);
unsigned char atto640_errorcheck(char *data, unsigned int len);

static int atto640_mcu_list_fmts(struct i2c_client *client, ISP_STREAM_INFO *stream_info, int *frm_fmt_size,struct atto640 *);
static int atto640_mcu_list_ctrls(struct i2c_client *client,
			  ISP_CTRL_INFO * mcu_ctrl_info, struct atto640 *);
//static int atto640_mcu_get_sensor_id(struct i2c_client *client, uint16_t * sensor_id);
static int atto640_mcu_get_cmd_status(struct i2c_client *client, uint8_t * cmd_id,
...
static int atto640_mcu_set_ctrl(struct i2c_client *client, uint32_t ctrl_id,
