...
unsigned int g_bload_flashaddr_atto640 = 0x0000;

uint8_t *fw_version_atto640 = NULL;

/* MCU communication variables */
unsigned char mc_data_atto640[MCU_BUFFER_SIZE];
unsigned char mc_ret_data_atto640[MCU_BUFFER_SIZE];

/*   Buffer to Send Bootloader CMDs */
unsigned char g_bload_buf_atto640[MAX_BUF_LEN] = { 0 };

unsigned short int g_bload_crc16_atto640 = 0x0000;

const char g_mcu_fw_buf_atto640[] =
#include "ecam30_gmsl_mcu_fw_atto640.txt"
    ;
